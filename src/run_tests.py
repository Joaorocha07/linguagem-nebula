...
runner = nebula.NebulaRunner(verbose=False)

print("\n" + "=" * 70)
print("TESTE 1: PRECEDÊNCIA")
print("=" * 70)
runner.executar_arquivo(str(TESTS_DIR / "teste_precedencia.neb"))

print("\n" + "=" * 70)
print("TESTE 2: CONDICIONAL")
print("=" * 70)
runner.executar_arquivo(str(TESTS_DIR / "teste_condicional.neb"))

print("\n" + "=" * 70)
print("TESTE 3: ERROS RECUPERÁVEIS")
print("=" * 70)
runner.executar_arquivo(str(TESTS_DIR / "teste_erros_recuperaveis.neb"))

print("\n" + "=" * 70)
print("TESTE 4: INVÁLIDO")
print("=" * 70)
runner.executar_arquivo(str(TESTS_DIR / "teste_invalido.neb"))

print("\n" + "=" * 70)
print("TESTE 5: PROGRAMA EXEMPLO")
print("=" * 70)
runner.executar_arquivo(str(ROOT_EXAMPLE / "programa_exemplo.neb"))
